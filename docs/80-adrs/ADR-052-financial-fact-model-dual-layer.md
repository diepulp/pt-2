---
id: ADR-052
title: Financial Fact Model (Dual-Layer)
status: Accepted
date: 2026-04-23
owner: Architecture Review
decision_scope: Pilot financial fact taxonomy, table-first anchoring, and authority-class boundaries
triggered_by: docs/issues/gaps/financial-data-distribution-standard/decisions/DECISION-CONSOLIDATION.md
supersedes:
  - docs/issues/gaps/financial-data-distribution-standard/decisions/interim/ADR-FINANCIAL-FACT-MODEL-DRAFT.md
  - docs/issues/gaps/financial-data-distribution-standard/decisions/interim/ADR-FINANCIAL-EVENT-INJESTION-UNIFICATION.md
related:
  - ADR-053
  - ADR-054
  - ADR-055
  - docs/issues/gaps/financial-data-distribution-standard/actions/SURFACE-RENDERING-CONTRACT.md
canonicalized_from: docs/issues/gaps/financial-data-distribution-standard/decisions/ADR-FINANCIAL-FACT-MODEL.md
...
Earlier drafts proposed absorbing grind into PFT via an `is_rated` attribute. `DECISION-CONSOLIDATION.md` rejected that direction. This ADR records the replacement model.
...
* Event propagation mechanics (see ADR-054)
* Surface rendering contract (see ADR-054 §6)
* Reconciliation workflows (see ADR-053)
