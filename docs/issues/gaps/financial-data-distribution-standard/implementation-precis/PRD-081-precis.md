...
- `supabase/migrations/20260511134741_wave2_finance_outbox_rls_hardening.sql` — Post-recreate assertion verifies zero authenticated policies on `finance_outbox`; `processed_messages` RLS enabled (deny-by-default)
