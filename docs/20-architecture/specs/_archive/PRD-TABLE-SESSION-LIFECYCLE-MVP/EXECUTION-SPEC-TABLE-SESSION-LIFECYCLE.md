...
**Bounded Context:** TableContextService (SRM v4.9.0)
...
CREATE TABLE table_session (
  ...
  opening_inventory_snapshot_id uuid NULL REFERENCES table_inventory_snapshot(id),
  closing_inventory_snapshot_id uuid NULL REFERENCES table_inventory_snapshot(id),
  drop_event_id uuid NULL REFERENCES table_drop_event(id),
  notes text NULL,
  metadata jsonb NULL,
...
| `missing_closing_artifact` | 400 | Close without drop or inventory snapshot |
