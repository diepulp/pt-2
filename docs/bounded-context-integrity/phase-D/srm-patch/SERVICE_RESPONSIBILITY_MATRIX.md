...
|---------|------|---------|-----------|
| **3.0.2** | 2025-10-21 | Integrated rating slip mid-session reward contract, lifecycle states, loyalty ledger extensions, and atomic issuance RPC | Aligns SRM with addendum ensuring Loyalty remains SoT while enabling auditable mid-session rewards |
| **3.0.1** | 2025-10-21 | Added CI acceptance checklists, centralized enum catalog, telemetry references, index stubs, and deprecation compliance gates | Provides mechanical validation inputs enabling automated bounded-context integrity enforcement |
