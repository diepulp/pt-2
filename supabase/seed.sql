...
INSERT INTO player (id, first_name, last_name, birth_date) VALUES
  ('a1000000-0000-0000-0000-000000000001', 'Potential', 'Unknown', '1980-05-15'),
  ('a1000000-0000-0000-0000-000000000002', 'High', 'Roller', '1975-11-22'),
  ('a1000000-0000-0000-0000-000000000003', 'Inco', 'Gnito', '1988-03-10'),
  ('a1000000-0000-0000-0000-000000000004', 'New', 'Here', '1992-08-05'),
  ('a1000000-0000-0000-0000-000000000005', 'Not', 'Sure', '1965-12-30'),
  ('a1000000-0000-0000-0000-000000000006', 'Cup', 'World', '1995-07-18');
...
-- Current session buy-ins (amounts in CENTS per ADR-031)
INSERT INTO player_financial_transaction (id, player_id, casino_id, visit_id, rating_slip_id, amount, tender_type) VALUES
  ('f1000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000001', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000001', 100000, 'cash'),
  ('f1000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000002', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000004', 500000, 'cash'),
  ('f1000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000003', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000003', 'd1000000-0000-0000-0000-000000000002', 200000, 'marker'),
  ('f1000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000004', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000004', 'd1000000-0000-0000-0000-000000000003', 50000, 'cash');
...
INSERT INTO player_financial_transaction (id, player_id, casino_id, visit_id, rating_slip_id, amount, tender_type, created_at) VALUES
  -- Player 1 buy-in ($1,000)
  ('f1000000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000001', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000005', 100000, 'cash', NOW() - INTERVAL '1 day' - INTERVAL '4 hours'),
  -- Player 5 high-roller session buy-ins ($10,000 + $5,000)
  ('f1000000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000005', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000006', 1000000, 'cash', NOW() - INTERVAL '1 day' - INTERVAL '7 hours'),
  ('f1000000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000005', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000006', 500000, 'marker', NOW() - INTERVAL '1 day' - INTERVAL '5 hours'),
  -- Player 6 small session buy-in ($200)
  ('f1000000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000006', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000007', 20000, 'cash', NOW() - INTERVAL '1 day' - INTERVAL '2 hours');
...
INSERT INTO player_financial_transaction (id, player_id, casino_id, visit_id, rating_slip_id, amount, tender_type, txn_kind, reason_code, note, created_by_staff_id, created_at) VALUES
  -- Player 1 cash-out (-$1,250)
  ('f1000000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000001', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000005', 'd1000000-0000-0000-0000-000000000005', -125000, 'cash', 'adjustment', 'other', 'Player cashed out at session end - chips to cash exchange at cage', '5a000000-0000-0000-0000-000000000001', NOW() - INTERVAL '1 day' - INTERVAL '2 hours'),
  -- Player 5 cash-out (-$18,000)
  ('f1000000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000005', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000006', 'd1000000-0000-0000-0000-000000000006', -1800000, 'cash', 'adjustment', 'other', 'VIP player session close - full chip redemption at cage window', '5a000000-0000-0000-0000-000000000001', NOW() - INTERVAL '1 day' - INTERVAL '3 hours'),
  -- Player 6 cash-out (-$150)
  ('f1000000-0000-0000-0000-000000000011', 'a1000000-0000-0000-0000-000000000006', 'ca000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000007', -15000, 'cash', 'adjustment', 'other', 'Session end cash-out - player redeemed remaining chips', '5a000000-0000-0000-0000-000000000002', NOW() - INTERVAL '1 day' - INTERVAL '1 hour');

-- Casino 2 transactions ($50,000)
INSERT INTO player_financial_transaction (id, player_id, casino_id, visit_id, rating_slip_id, amount, tender_type) VALUES
  ('f1000000-0000-0000-0000-000000000012', 'a1000000-0000-0000-0000-000000000005', 'ca000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000010', 'd1000000-0000-0000-0000-000000000010', 5000000, 'cash');
...
-- Amounts in CENTS per ADR-031 (e.g., 1000000 = $10,000)
INSERT INTO mtl_entry (id, patron_uuid, casino_id, staff_id, rating_slip_id, visit_id, amount, direction, area, txn_type, idempotency_key) VALUES
  -- Player 5's large buy-in yesterday ($10,000 — over CTR threshold)
  ('a5000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 'ca000000-0000-0000-0000-000000000001', '5a000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000006', 1000000, 'in', 'table', 'buy_in', 'fin:seed-mtl-001'),
  -- Player 5's additional marker ($5,000 credit taken at cage) - marker type doesn't require fin: prefix
  ('a5000000-0000-0000-0000-000000000002', 'a1000000-0000-0000-0000-000000000005', 'ca000000-0000-0000-0000-000000000001', '5a000000-0000-0000-0000-000000000002', 'd1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000006', 500000, 'in', 'cage', 'marker', NULL),
  -- Player 5's cash-out ($18,000 chips to cash at cage)
  ('a5000000-0000-0000-0000-000000000003', 'a1000000-0000-0000-0000-000000000005', 'ca000000-0000-0000-0000-000000000001', '5a000000-0000-0000-0000-000000000001', 'd1000000-0000-0000-0000-000000000006', 'b1000000-0000-0000-0000-000000000006', 1800000, 'out', 'cage', 'cash_out', 'fin:seed-mtl-003'),
  -- Casino 2 high-roller current session ($50,000)
  ('a5000000-0000-0000-0000-000000000004', 'a1000000-0000-0000-0000-000000000005', 'ca000000-0000-0000-0000-000000000002', '5a000000-0000-0000-0000-000000000007', 'd1000000-0000-0000-0000-000000000010', 'b1000000-0000-0000-0000-000000000010', 5000000, 'in', 'table', 'buy_in', 'fin:seed-mtl-004');
