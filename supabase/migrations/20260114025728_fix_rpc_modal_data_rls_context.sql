-- ============================================================================
-- Migration: Fix rpc_get_rating_slip_modal_data RLS Context Call
-- ============================================================================
-- Purpose: Fix permission denied error for set_rls_context (deprecated)
-- Issue: Function was calling deprecated set_rls_context() instead of
--        set_rls_context_from_staff() per ADR-024
--
-- Error: "permission denied for function set_rls_context"
-- Cause: set_rls_context has been revoked from authenticated users per ADR-024
-- Fix: Use set_rls_context_from_staff() which derives context from auth.uid()
-- ============================================================================
...
COMMENT ON FUNCTION rpc_get_rating_slip_modal_data(uuid, uuid) IS
  'BFF RPC: Single round trip aggregation for rating slip modal display. ADR-024 compliant - uses set_rls_context_from_staff().';
