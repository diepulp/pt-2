-- ============================================================================
-- Fix: rpc_import_execute — replace min(uuid) with array_agg pattern
--
-- PostgreSQL does not have a built-in min() aggregate for the uuid type.
-- Replace min(p.id) with (array_agg(p.id))[1] for identifier resolution.
--
