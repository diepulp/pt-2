          ...
          <Reveal delay={60}>
            <div className="group relative mb-16 overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02] transition-all duration-500 hover:border-accent/20">
              ...
              <div className="relative overflow-hidden">
                <img
                  src="/shift-dash-scren.png"
                  alt="Shift Dashboard — casino-wide floor view with KPIs, coverage, alerts, and activity radar"
              ...
              <div className="relative px-5 py-4 border-t border-white/[0.06] bg-white/[0.01]">
                ...
                <p className="text-[13px] font-semibold text-[#F7F8F8] mb-0.5">
                  Floor Operations → Operational Intelligence
                </p>
                <p className="text-[12px] leading-relaxed text-[#95A2B3]/60">
                  Casino-wide KPIs, attribution ratio, cash alerts, and active
                  player roster — the full floor picture, live during the shift.
                </p>
              </div>
            </div>
          </Reveal>
        ...
        <div className="relative mx-auto max-w-5xl px-6">
          ...
          <Reveal delay={100}>
            <div className="group relative mb-16 overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.02] transition-all duration-500 hover:border-accent/20">
              ...
              <div className="relative overflow-hidden">
                <img
                  src="/player-360-screen.png"
                  alt="Player 360 — complete player operational record with identity, session history, rating slips, and loyalty position"
                  className="w-full block"
                  loading="lazy"
                />
                <div className="absolute bottom-0 inset-x-0 h-12 bg-gradient-to-t from-[#000212]/60 to-transparent pointer-events-none" />
              ...
              <div className="relative px-5 py-4 border-t border-white/[0.06] bg-white/[0.01]">
                ...
                <p className="text-[13px] font-semibold text-[#F7F8F8] mb-0.5">
                  Session Tracking → Operational Accountability
                </p>
                <p className="text-[12px] leading-relaxed text-[#95A2B3]/60">
                  Full player operational record surfaced from the pit —
                  identity, visit continuity, rating slips, financial activity,
                  and filterable interaction timeline.
                </p>
              </div>
            </div>
          </Reveal>
