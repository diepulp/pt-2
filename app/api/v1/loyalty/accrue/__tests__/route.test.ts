 ...
 *
 * Route Handler Tests: /api/v1/loyalty/accrue
 *
 * Tests POST (accrue) endpoint.
...
jest.mock('@/services/loyalty', () => ({
  createLoyaltyService: jest.fn(() => ({
    accrueOnClose: jest.fn().mockResolvedValue({
...
const VALID_RATING_SLIP_ID = '123e4567-e89b-12d3-a456-426614174001';
const VALID_CASINO_ID = '123e4567-e89b-12d3-a456-426614174002';
const VALID_IDEMPOTENCY_KEY = '123e4567-e89b-12d3-a456-426614174003';

describe('POST /api/v1/loyalty/accrue', () => {
  it('exports POST handler', () => {
    expect(typeof POST).toBe('function');
  });

  it('requires Idempotency-Key header', async () => {
    const request = createMockRequest('POST', '/api/v1/loyalty/accrue', {
      body: {
  ...
  it('returns 201 on new accrual', async () => {
    const request = createMockRequest('POST', '/api/v1/loyalty/accrue', {
      headers: {
