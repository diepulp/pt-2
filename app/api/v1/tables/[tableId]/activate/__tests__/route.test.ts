 ...
 *
 * POST /api/v1/tables/[tableId]/activate Route Handler Tests
 *
 * Tests for table activation endpoint.
 *
...
jest.mock('@/services/table-context/table-lifecycle', () => ({
  activateTable: jest.fn().mockResolvedValue({
...
describe('POST /api/v1/tables/[tableId]/activate', () => {
  ...
  it('accepts valid tableId with idempotency key', async () => {
    const request = createMockRequest(
      'POST',
      `/api/v1/tables/${TABLE_ID}/activate`,
      {
        headers: {
