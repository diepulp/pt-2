 ...
 *
 * POST /api/v1/tables/[tableId]/deactivate Route Handler Tests
 *
 * Tests for table deactivation endpoint.
 *
...
jest.mock('@/services/table-context/table-lifecycle', () => ({
  deactivateTable: jest.fn().mockResolvedValue({
...
describe('POST /api/v1/tables/[tableId]/deactivate', () => {
  ...
  it('accepts valid tableId with idempotency key', async () => {
    const request = createMockRequest(
      'POST',
      `/api/v1/tables/${TABLE_ID}/deactivate`,
      {
        headers: {
