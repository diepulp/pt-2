...
jest.mock('@/services/rating-slip', () => ({
  createRatingSlipService: jest.fn(() => ({
    ...
    close: jest.fn().mockResolvedValue({ id: '123e4567-e89b-12d3-a456-426614174000' }),
    start: jest.fn().mockResolvedValue({ id: '123e4567-e89b-12d3-a456-426614174003' }),
  })),
}));
...
describe('POST /api/v1/rating-slips/[id]/move', () => {
  ...
  it('requires Idempotency-Key header', async () => {
    const request = createMockRequest('POST', `/api/v1/rating-slips/${slipId}/move`, {
