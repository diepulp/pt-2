...
describe('Player Management E2E', () => {
  ...
  describe('Create Player Workflow', () => {
    ...
    it('should handle duplicate email error', () => {
      ...
      cy.contains('Error creating player', { timeout: 10000 }).should('be.visible');
    });
  ...
  describe('Performance Tests', () => {
    it('should load the page within 2 seconds', () => {
      ...
      cy.visit(playersUrl);
      cy.contains('Player Management').should('be.visible').then(() => {
    ...
    it('should handle form submission within reasonable time', () => {
      ...
      cy.contains('Player created successfully', { timeout: 10000 }).should('be.visible').then(() => {
