...
const FeaturesSection = dynamic(() => import('./sections/features-section').then(mod => ({ default: mod.FeaturesSection })), {
  ssr: false,
...
const PricingSection = dynamic(() => import('./sections/pricing-section').then(mod => ({ default: mod.PricingSection })), {
  ssr: false,
  loading: () => <div className="h-96" />
})

const ContactSection = dynamic(() => import('./sections/contact-section').then(mod => ({ default: mod.ContactSection })), {
  ssr: false,
  loading: () => <div className="h-96" />
})
