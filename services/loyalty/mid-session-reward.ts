...
function assertEligibleStatus(status: string): asserts status is RatingSlipStatusForReward {
  if (!ELIGIBLE_STATUSES.includes(status as RatingSlipStatusForReward)) {
    throw new Error(
