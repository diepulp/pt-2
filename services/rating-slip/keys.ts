...
type VisitScopedFilters = Pick<RatingSlipListFilters, 'cursor' | 'limit' | 'status'>;
...
export const ratingSlipKeys = {
  ...
  detail: (ratingSlipId: string) =>
    [...ROOT, 'detail', ratingSlipId] as const,
  byVisit: (
    visitId: string,
    filters: VisitScopedFilters = {},
  ...
  update: (ratingSlipId: string) =>
    [...ROOT, 'update', ratingSlipId] as const,
