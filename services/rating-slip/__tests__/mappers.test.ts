...
describe("Rating Slip Mappers", () => {
  ...
  describe("toRatingSlipWithDurationDTO", () => {
    it("should include duration_seconds", () => {
      const result = toRatingSlipWithDurationDTO(mockRatingSlipRowClosed, 14400);
    ...
    it("should preserve all slip fields with duration", () => {
      const result = toRatingSlipWithDurationDTO(mockRatingSlipRowClosed, 10800);
  ...
  describe("toRatingSlipPauseDTOList", () => {
    ...
    it("should map multiple pauses", () => {
      const result = toRatingSlipPauseDTOList([mockPauseRow, mockPauseRowActive]);
    ...
    it("should preserve order", () => {
      const result = toRatingSlipPauseDTOList([mockPauseRowActive, mockPauseRow]);
