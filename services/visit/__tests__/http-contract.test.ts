 ...
 *
 * Classification: Smoke (S3.7) — shallow typeof checks only.
 * Reclassified per TESTING_GOVERNANCE_STANDARD.md §9.2.
 * Does NOT count toward Trusted-Local verification status.
 *
