...
export const FINANCIAL_TXN_SELECT =
  "id, casino_id, player_id, visit_id, rating_slip_id, amount, direction, source, tender_type, created_by_staff_id, related_transaction_id, created_at, gaming_day, idempotency_key" as const;
