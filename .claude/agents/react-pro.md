...
tools: Read, Write, Edit, MultiEdit, Grep, Glob, Bash, LS, WebFetch, WebSearch, Task, mcp**context7**resolve-library-id, mcp**context7**get-library-docs, mcp**magic**21st_magic_component_builder, mcp**magic**21st_magic_component_inspiration, mcp**magic**21st_magic_component_refiner
model: sonnet
