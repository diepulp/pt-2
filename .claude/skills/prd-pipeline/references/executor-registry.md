...
This document defines the complete mapping of workstream types to executors for the PRD pipeline.
...
But within the PRD pipeline, **all workstreams must use Skills**.
