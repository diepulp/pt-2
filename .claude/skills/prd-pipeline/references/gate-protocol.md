...
This document specifies the UX and behavior for approval gates in the PRD pipeline.
...
2. **Include**:
   ...
   - Artifact paths
   - Timestamp
3. **Location**: `.claude/skills/prd-pipeline/checkpoints/{PRD-ID}.json`
