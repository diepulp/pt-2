/**
 * Shared Header Normalization Module (WS2)
 *
 * Pure utility functions for normalizing CSV headers and field values.
 * Used by both the Next.js browser app and the standalone Node.js
 * ingestion worker. Contains NO Node-only APIs.
 *
 * @see PRD-039 Server-Authoritative CSV Ingestion Worker
 * @see SCAFFOLD-SERVER-CSV-INGESTION (WS2)
 */
