...
export const RATING_SLIP_ERROR_MESSAGES: Record<RatingSlipErrorCode, string> = {
  ...
  RATING_SLIP_INVALID_STATE: 'Rating slip is in an invalid state for this operation',
  RATING_SLIP_MISSING_REQUIRED_DATA: 'Rating slip is missing required telemetry data',
...
export const TABLE_CONTEXT_ERROR_MESSAGES: Record<TableContextErrorCode, string> = {
...
export class DomainError extends Error {
  ...
  constructor(
    ...
    this.code = code;
    this.httpStatus = options?.httpStatus ?? DomainError.getDefaultHttpStatus(code);
